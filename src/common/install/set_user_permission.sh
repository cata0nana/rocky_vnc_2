...
echo "y" | /opt/android-sdk/cmdline-tools/tools/bin/sdkmanager "platform-tools" "platforms;android-25" "emulator"

echo "y" | /opt/android-sdk/cmdline-tools/tools/bin/sdkmanager "system-images;android-25;default;armeabi-v7a"

echo "y" | /opt/android-sdk/cmdline-tools/tools/bin/avdmanager create avd -n emuTest -k "system-images;android-25;default;armeabi-v7a"
